  ...
  methods: {
    ...
    typeChange(indexValue) {
      ...
      if (selectedType.indexOf("招中标") !== -1) {
        ...
        this.replaceTxtDisabled=false
        this.data.value =
          "被告王彤云于本判决发生法律效力之日起十日内归还原告交通银行股份有限公司四川省分行透支款本息及费用11509.71元(截止2014年6月2日)及从2014年6月3日起至实际清偿之日止的利息、费用(按《交通银行太平洋个人贷记卡领用合约》的约定计算).如果被告未按照本判决指定的期间履行给付金钱义务,应当依照《中华人民共和国民事诉讼法》第二百五十三条之规定,加倍支付迟延履行期间的债务利息.案件受理费88元,公告费112元,共计200元,由被告王彤云支付";
